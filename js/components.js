    ...
    <footer class="bg-background pt-16 pb-8 px-6 border-t border-border mt-10">
      <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 items-start mb-12">
          ...
          <div class="flex flex-col items-center justify-center text-center space-y-4">
            <div class="relative group">
              ...
              <a href="${cepinUrl}" class="relative bg-primary text-primary-foreground font-semibold shadow-carnival hover:bg-primary-glow hover:-translate-y-0.5 transition-all text-base py-3 px-8 rounded-full flex items-center justify-center gap-2 cursor-pointer border-0">
        ...
        <div class="border-t border-border pt-8 text-center text-xs text-muted-foreground">
          <p>&copy; ${currentYear} CEPIN JCR. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  `;
...
try { renderBottomNav(); } catch(e) { console.error("Error in renderBottomNav", e); }
